...
useEffect(() => {
  ...
  return (
    ...
    sm:justify-evenly max-sm:flex-col backdrop-blur-xl'>
      {/* left */}
      ...
      <form onSubmit={onSubmitHandler} className="border-2 bg-white/8 text-white border-gray-500 p-6 flex flex-col gap-6 rounded-lg shadow-lg">
        ...
        )}
        {
          currState === 'Sign up' && isDataSubmitted && (
            ...
            row={4} className='p-2 border border-gray-500 rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500'placeholder='provide a short bio' required ></textarea>
          )
        }
